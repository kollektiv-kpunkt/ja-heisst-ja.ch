...
$i18n = array(
    ...
    // META TAGS
    "metatitle" => "Solo se sì! - Modificare l'Art. 190",
    "metadescr" => "Il Consiglio degli Stati ha presentato la sua proposta di revisione del diritto penale in materia di reati sessuali. Nota: insufficiente.",
    ...
    // FORM DEFAULTS
    "anrede-select" => "Selezionare il saluto...",
    "anrede-herr" => "Signore",
    "anrede-frau" => "Signora",
    "anrede-neutral" => "Forma neutra",
    "fname" => "Nome",
    "lname" => "Cognome",
    "email" => "E-mail",
    "address" => "Via/Numero",
    ...
    "s2-q1" => "Che cosa è attualmente punibile?",
    "s2-a1" => "Sino ad oggi si considera violenza carnale soltanto la penetrazione vaginale non desiderata imposta a una «persona di sesso femminile», e soltanto se commessa per mezzo della vio-lenza fisica o di minacce.",
    ...
    // DONATE
    "donate-content" => "Fai una donazione a favore della nostra campagna per un diritto penale in materia di reati sessuali secondo il principio «Solo se sì». Grazie mille!",
